...
namespace Evaluacion2.Data.Usuario
{
    public class UsuarioRepositoryPostgreSql : IUsuarioRepository
    {
        ...
        public UsuarioRepositoryPostgreSql(string connectionString)
        {
        ...
        public IEnumerable<UsuarioModel> GetAll()
        {
            ...
            {
                connection.Open();
                var command = new NpgsqlCommand("SELECT * FROM Usuarios", connection);
        ...
        public UsuarioModel GetById(int id)
        {
            ...
            {
                connection.Open();
                var command = new NpgsqlCommand("SELECT * FROM Usuarios WHERE Id = @Id", connection);
        ...
        public void Delete(int id)
        {
            ...
            {
                connection.Open();
                var command = new NpgsqlCommand("DELETE FROM Usuarios WHERE Id = @Id", connection);
                command.Parameters.AddWithValue("@Id", id);
